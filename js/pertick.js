...
function updateresources() {
	var rpquickfix = document.getElementById("total_RP");
	rpquickfix.innerHTML = game.resources.researchPoints.owned.toFixed(0);
	var arrResources = ["pop","popmax","total_wood","woodmax","total_stone","stonemax","total_coal","coalmax","total_clay","claymax","currentfood","maxfood","maxwater","total_logs","total_blocks","total_steam","total_bricks"]
	var arrResourceDiv = [game.stats.population,game.stats.populationMax,game.resources.wood.owned,game.resources.wood.max,game.resources.stone.owned,game.resources.stone.max,game.resources.charcoal.owned,game.resources.charcoal.max,game.resources.clay.owned,game.resources.clay.max,game.resources.food.owned,game.resources.food.max,game.resources.water.max,game.resources.logs.owned,game.resources.concrete.owned,game.resources.steam.owned,game.resources.bricks.owned]
...
function updatebuildings() {
	...
	var arrBuildingDiv = [game.buildings.cabins.owned,(50 * (Math.pow(game.buildings.cabins.owned + 1,1.9))),game.buildings.huts.owned,(5 * (Math.pow(game.buildings.huts.owned + 1,1.75))),game.buildings.roundHouses.owned,(33 * (Math.pow(game.buildings.roundHouses.owned + 1,1.47))),game.buildings.granaries.owned,(35 * (Math.pow(game.buildings.granaries.owned + 1,1.6))),(50 * (Math.pow(game.buildings.granaries.owned + 1,1.45))),game.buildings.storeHouses.owned,(150 * (Math.pow(game.buildings.storeHouses.owned + 1,1.35))),game.buildings.researchTowers.owned,(100 * (Math.pow(game.buildings.researchTowers.owned + 1,1.04))),game.buildings.sawMills.owned,(25 * (Math.pow(game.buildings.sawMills.owned + 1,1.5))),(1 * (Math.pow(game.buildings.sawMills.owned + 1,1.5))),game.buildings.apartments.owned,(50 * (Math.pow(game.buildings.apartments.owned + 1,1.95))),(((50 * (Math.pow(game.buildings.apartments.owned + 1,1.95))))/2),game.buildings.fields.owned,(50 * (Math.pow(game.buildings.fields.owned + 1,1.07))),game.buildings.aqueducts.owned,(150 * (Math.pow(game.buildings.aqueducts.owned + 1,1.25))),((150 * (Math.pow(game.buildings.aqueducts.owned + 1,1.25)))/2),(100 * (Math.pow(game.buildings.aqueducts.owned + 1,1.15)))]
