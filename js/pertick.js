...
function updatebuildings() {
	...
	var arrBuildingDiv = [game.buildings.cabins.owned,(50 * (Math.pow(game.buildings.cabins.owned + 1,1.9))),game.buildings.huts.owned,(10 * (Math.pow(game.buildings.huts.owned + 1,1.95))),game.buildings.roundHouses.owned,(33 * (Math.pow(game.buildings.roundHouses.owned + 1,1.47))),game.buildings.granaries.owned,(35 * (Math.pow(game.buildings.granaries.owned + 1,1.6))),(50 * (Math.pow(game.buildings.granaries.owned + 1,1.45))),game.buildings.storeHouses.owned,(150 * (Math.pow(game.buildings.storeHouses.owned + 1,1.35))),game.buildings.researchTowers.owned,(100 * (Math.pow(game.buildings.researchTowers.owned + 1,1.04))),game.buildings.sawMills.owned,(25 * (Math.pow(game.buildings.sawMills.owned + 1,1.5))),(1 * (Math.pow(game.buildings.sawMills.owned + 1,1.5))),game.buildings.apartments.owned,(50 * (Math.pow(game.buildings.apartments.owned + 1,1.95))),(((50 * (Math.pow(game.buildings.apartments.owned + 1,1.95))))/2),game.buildings.fields.owned,(50 * (Math.pow(game.buildings.fields.owned + 1,1.07))),game.buildings.aqueducts.owned,(150 * (Math.pow(game.buildings.aqueducts.owned + 1,1.25))),((150 * (Math.pow(game.buildings.aqueducts.owned + 1,1.25)))/2),(1000 * (Math.pow(game.buildings.aqueducts.owned + 1,1.15)))]
